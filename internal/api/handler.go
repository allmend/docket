...
func (h *Handler) Routes(r chi.Router) {
	...
	r.Put("/workspaces/{teamSlug}/capacity", h.UpdateTeamCapacity)
	r.Post("/workspaces/{teamSlug}/tracks", h.SaveTrack)
	r.Delete("/workspaces/{teamSlug}/tracks/{tagID}", h.DeleteTrack)
	...
	r.Get("/tickets/{ticketID}/body/edit", h.TicketBodyEditForm)
	r.Get("/tickets/{ticketID}/body/view", h.TicketBodySectionView)
